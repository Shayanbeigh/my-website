...
export async function POST(request) {
  try {
    ...
    const html = '<div style="font-family:sans-serif;max-width:500px;margin:0 auto;">'
      ...
      + '<p style="font-size:16px;color:#444;">Someone just subscribed to the my-website newsletter.</p>'
      + '<div style="background:#f9f9f9;border-radius:8px;padding:16px 20px;margin-top:16px;">'
      + '<p style="margin:0;font-size:15px;color:#1a1a1a;"><strong>Email:</strong> ' + email + '</p>'
      + '</div>'
      + '</div>'
